                ...
                <div class="col-12 ">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="mt-3" method="post" action="../SuaDanhMuc.php" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="nametext" name="tenloaisanpham"
                                            placeholder="Ten San Pham"  value="<?php echo $data1['tenloaisanpham']; ?>"> 
