...
public class ChiTietDanhMucAdapter extends RecyclerView.Adapter<ChiTietDanhMucAdapter.GetViewChiTietDanhMuc> {
    ...
    public void onBindViewHolder(@NonNull GetViewChiTietDanhMuc holder, int position) {
        ...
        holder.gia_danhmuc.setText(decimalFormat.format(Double.parseDouble(monResult.getGiasanpham()))+" đ");
        holder.tenmon_danhmuc.setText(monResult.getTensanpham());
        holder.mota_danhmuc.setText(monResult.getMotasanpham());
