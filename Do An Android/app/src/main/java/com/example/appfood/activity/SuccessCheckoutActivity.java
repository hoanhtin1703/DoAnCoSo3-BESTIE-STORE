...
public class SuccessCheckoutActivity extends AppCompatActivity {
    TextView txt_tenkhachhang,txt_email,txt_sodienthoai,txt_diachi,txt_tongtien;
    ...
    private void getThongTinKhachHang() {
        ...
        txt_diachi.setText(ThongTinKhachHangActivity.user_address.getText().toString());
    ...
    public void ToHome(View view) {
        ...
        trangchu.putExtra("idkhachhang",ThongTinKhachHangActivity.id);
